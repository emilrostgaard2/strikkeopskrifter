...
<form class="foot-news nl" action="https://9b9ec015.sibforms.com/serve/MUIFAORQaHiwpckMv0mbdg89ygAXicN7FGmQajpiynr9Pcz29_-CNqTx2424QpAOieROfC3J4llDasqvFQR722BgB-zdGUmzJ6RBEpBdUzaMeNvUSZuZMdsxGVtP7NBLb_NF8u9Hdgkp6um8Bs08Sy-cLLvRHfpZzyHzaW7johT8b0OuC_Nhhy8aQHbPR-MktYc4WwBeZ28IEI3Bfg==?isAjax=1" method="post"><input type="email" name="EMAIL" placeholder="din@mail.dk" aria-label="E-mail" required autocomplete="email"><input type="text" name="email_address_check" value="" class="nl-hp" tabindex="-1" autocomplete="off"><input type="hidden" name="locale" value="da"><button class="btn btn-primary btn-sm" type="submit">Få prisfald</button></form></div>
...
<aside class="panel"><h3 style="margin-bottom:6px">Følg prisen</h3><p class="muted small" style="margin:0 0 14px">Få en mail, når {e(name)} falder i pris hos en af butikkerne.</p><form class="foot-news nl" action="https://9b9ec015.sibforms.com/serve/MUIFAORQaHiwpckMv0mbdg89ygAXicN7FGmQajpiynr9Pcz29_-CNqTx2424QpAOieROfC3J4llDasqvFQR722BgB-zdGUmzJ6RBEpBdUzaMeNvUSZuZMdsxGVtP7NBLb_NF8u9Hdgkp6um8Bs08Sy-cLLvRHfpZzyHzaW7johT8b0OuC_Nhhy8aQHbPR-MktYc4WwBeZ28IEI3Bfg==?isAjax=1" method="post" data-garn="{e(name)}"><input type="email" name="EMAIL" placeholder="din@mail.dk" aria-label="E-mail" required autocomplete="email"><input type="text" name="email_address_check" value="" class="nl-hp" tabindex="-1" autocomplete="off"><input type="hidden" name="locale" value="da"><button class="btn btn-primary btn-sm" type="submit">Prisalarm</button></form>
...
<h2>Rettelser</h2><p>Finder vi eller læserne en fejl, retter vi den og noterer det her.</p><ul class="toplist small"><li>17. september 2026: Løbelængden på Drops Air rettet fra 125 til 150 m pr. 50 g – tak til Sarah, der skrev til os.</li><li>September 2026: Sitet lanceret med prisdata fra Rito, Önling, Hobbygarn, Kreamok, Broen Garn og Kreativgarn.</li></ul>
